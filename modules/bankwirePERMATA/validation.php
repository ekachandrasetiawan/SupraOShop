...
$mailVars = array(
	'{bankwire_owner}' => Configuration::get('PERMATA_OWNER'),
	'{bankwire_details}' => nl2br(Configuration::get('PERMATA_DETAILS')),
	'{bankwire_address}' => nl2br(Configuration::get('PERMATA_ADDRESS'))
);
